...
using Shared.Enums;
using SocialMediaService;
using Swashbuckle.AspNetCore.Filters;
using ResponseDescription = SocialMediaService.ResponseDescription;
...
string filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "logs/SocialAppSocialMediaService.log");
...
app.MapHealthChecks("/socialmediaapi/health", new HealthCheckOptions
{
...
app.MapGet("/", () => "Social App Backend SocialMediaApi");
app.MapControllers();
app.Run();